...
export function SidebarNav({ items, onNavigate }: SidebarNavProps) {
  ...
  return (
    <div className="flex h-full min-h-0 flex-col bg-white/82 p-5 backdrop-blur-xl">
      ...
      <div className="mt-4 rounded-[26px] border border-border/80 bg-accent-soft/40 p-4">
